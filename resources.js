...
const allResources = [
    ...
    { id: 3, category: "電子資料庫", title: "CDC Wonde", desc: "提供使用NCHS的公共衛生方面的統計資料之系統。", link: "https://wonder.cdc.gov/" },
    { 
        id: 4, 
        category: "電子資料庫", 
    ...
    { id: 10, category: "電子資料庫", title: "Free eMedical Journals", desc: "本平台匯集全球數千種免費全文醫學期刊，提供即時的學術文獻檢索。透過推動開放獲取，打破資訊門檻，是醫護人員與研究者獲取高品質、零預算學術資源的權威入口。", link: "http://www.freemedicaljournals.com/" },
    { 
        id: 11, 
        category: "電子資料庫", 
    ...
    { id: 13, category: "電子資料庫", title: "JSTOR (論文數據庫)", desc: "JSTOR 為全球知名非營利數位圖書館，提供跨學科核心過刊與學術圖書全文。其深厚的人文社科典藏，協助研究者追蹤學術脈絡，是全球學界最受信賴的數位研究環境。", link: "https://www.jstor.org/" },
    { id: 14, category: "電子資料庫", title: "MEDLINE with Full Text", desc: "本資料庫以權威 MEDLINE 索引為基礎，額外提供數百種核心醫學期刊全文。涵蓋臨床、護理及生醫領域，協助研究者跨越摘要限制，一站式獲取高品質實證醫學文獻。", link: "https://hsc.idm.oclc.org/login?url=https://research.ebsco.com/c/57o3ql/search/results?q=&autocorrect=y&db=mnh&expanders=concept&limiters=FT%3AY&searchMode=boolean&searchSegment=all-results&skipResultsFetch=true&sqId=sq%3Ac00c8818-8a68-4dbd-b20b-b3bc37c0941d" },
    { id: 15, category: "電子資料庫", title: "MedicineNet", desc: "依英文字母A~Z查詢。每一個醫學名詞都解釋得相當清楚，提供大眾最新的醫療資訊。", link: "https://www.medicinenet.com/" },
    { id: 16, category: "電子資料庫", title: "Nature Aging", desc: "《自然-老化》（Nature Aging）是 Nature Portfolio 於 2021 年創刊的頂尖同行評審期刊，專注於老化的生物學機制、相關疾病、轉譯醫學及高齡化社會的社會經濟影響。該期刊旨在提供跨學科平台，涵蓋從基礎研究到臨床介入、改善老年人生活品質的研究，2024年影響因子為19.4。", link: "https://hsc.idm.oclc.org/login?url=https://www.nature.com/nataging" },
    { id: 17, category: "電子資料庫", title: "Nature Archive : 1987-1996", desc: "本資料庫完整收錄 1869 年至今的《Nature》過刊，見證 DNA 結構等重大科學突破。透過高品質數位化文獻，為研究科學史與追蹤全球學術演進提供不可取代的權威資源。", link: "https://www.nature.com/" },
    { id: 18, category: "電子資料庫", title: "On-Line Medical Dictionary", desc: "本詞典是專為醫學專業人士設計的在線檢索系統，收錄疾病、藥物與生物化學等精確術語。提供即時定義與交叉檢索功能，是提升醫護人員溝通效率與學術準確性的重要工具。", link: "https://www.online-medical-dictionary.org/" },
    { 
        id: 19, 
        category: "電子資料庫", 
    ...
    { id: 20, category: "電子資料庫", title: "Primal Pictures：3D Real Time (校內連線)", desc: "模擬3D立體呈現人體的層次感及其構造，收錄共12個模組。", link: "https://www.anatomy.tv/" },
    { id: 21, category: "電子資料庫", title: "ProQuest Coronavirus Research Database", desc: "本資料庫整合全球冠狀病毒相關研究，涵蓋學術期刊、預印本及最新臨床報導。透過一站式免費檢索，支援醫護與科研人員即時掌握疫情動向，加速全球公共衛生研究合作。", link: "https://hsc.idm.oclc.org/login?url=https://www.proquest.com/coronavirus?accountid=11513" },
    { id: 22, category: "電子資料庫", title: "ProQuest Digitale Bibliothek Deutscher Klassiker", desc: "本資料庫收錄中世紀至 19 世紀核心德語文獻，以權威德意志經典出版社版本為基礎。提供文學、哲學及歷史著作的全文檢索，是德語研究領域最完整的數位典藏資源。", link: "https://hsc.idm.oclc.org/login?url=https://www.proquest.com/dkv?accountid=11513" },
    { 
        id: 23, 
        category: "電子資料庫", 
    ...
    { id: 24, category: "電子資料庫", title: "ProQuest Kafka Werke", desc: "本資料庫收錄卡夫卡的小說、信件及日記，並以權威評論版為基礎。提供精確全文檢索與原始文本對照，是研究現代主義文學、卡夫卡生平與創作脈絡的核心數位資源。", link: "https://hsc.idm.oclc.org/login?url=https://www.proquest.com/kafka?accountid=11513" },
    { 
        id: 25, 
        category: "電子資料庫", 
    ...
    { id: 27, category: "電子資料庫", title: "ProQuest Political Science Database", desc: "本資料庫收錄政治學、國際關係及公共政策等核心文獻。匯集數百種全文學術期刊、評論與工作論文，為全球政治趨勢分析、法律研究與社會科學探討提供權威支援。", link: "https://hsc.idm.oclc.org/login?url=https://www.proquest.com/politicalscience?accountid=11513" },
    { id: 28, category: "電子資料庫", title: "ProQuest Publicly Available Content Database", desc: "本資料庫匯集全球經同行評審的公開取閱（OA）資源，涵蓋學術期刊、預印本及學位論文。協助研究者一站式檢索高品質免費文獻，全面提升學術資訊的可及性。", link: "https://hsc.idm.oclc.org/login?url=https://www.proquest.com/publiccontent?accountid=11513" },
    { id: 29, category: "電子資料庫", title: "ProQuest Schillers Werke", desc: "本資料庫以權威《國家版》為基礎，完整收錄席勒的戲劇、詩歌及哲學著作。提供精確的全文檢索與文本分析功能，是研究德語文學與古典主義不可或缺的數位資源。", link: "https://hsc.idm.oclc.org/login?url=https://www.proquest.com/schiller?accountid=11513" },
    { id: 30, category: "電子資料庫", title: "ProQuest The Vogue Archive", desc: "本資料庫完整收錄 1892 年至今的美國版《Vogue》。透過高畫質影像重現每頁內容與廣告，是研究時尚演變、性別議題與視覺設計不可或缺的權威數位典藏。", link: "https://hsc.idm.oclc.org/login?url=https://www.proquest.com/vogue?accountid=11513" },
    { 
        id: 31, 
        category: "電子資料庫", 
        title: "Reaxys 化學資料庫", 
    ...
    { id: 36, category: "電子資料庫", title: "Visible Body：Physiology Animation (校內)", desc: "Physiology Animations 透過高畫質 3D 動畫，生動呈現人體生理運作與常見病理變化。結合專業語音解說，將複雜的生物醫學觀念轉化為直觀的視覺體驗。", link: "https://ovidsp.ovid.com/ovidweb.cgi?T=JS&NEWS=n&CSC=Y&PAGE=main&D=phan15" },
    { id: 37, category: "電子資料庫", title: "Web Of Science", desc: "<span class='text-danger fw-bold'>【臺灣學術電子資源永續發展計畫購置】</span>Web of Science 是全球權威學術引文數據庫，涵蓋 SCI 等核心期刊。提供精確的引文索引與影響力分析，是學術評鑑與科學研究的重要基準指標。", link: "https://hsc.idm.oclc.org/login?url=https://www.webofscience.com/wos/woscc/smart-search" },
    { id: 38, category: "電子資料庫", title: "WHO Statistical Information System", desc: "WHOSIS 是世衛組織建立的統計資訊系統，匯集全球衛生指標。提供死亡率、疾病負擔及醫療資源等精確數據，是國際公共衛生監測與政策制定的核心依據。", link: "https://www.who.int/data/gho" },
    { 
        id: 39, 
        category: "電子資料庫", 
    ...
    { id: 40, category: "電子資料庫", title: "中文圖書資訊學文獻摘要資料庫 CLISA", desc: "教育部99植根計畫補助全國使用。收錄年代：1955-2011。", link: "http://newsdb.ncl.edu.tw/ttscgi/ttsweb?@0:0:1:clisa@@0.0773186696288155" },
    { id: 41, category: "電子資料庫", title: "中央研究院-研之有物", desc: "親身採訪研究團隊，寫成科普報導，帶大家直擊研究前線，探究科學和生活的關係。", link: "https://research.sinica.edu.tw/" },
    { 
        id: 42, 
        category: "電子資料庫", 
        title: "台灣商學企管資料庫", 
    ...
    { id: 43, category: "電子資料庫", title: "全國學術版人文及社會科學資料庫", desc: "包含多種國科會歷年購置的國外人文及社會科學資料庫內容。", link: "https://hsc.idm.oclc.org/login?url=http://huso.stpi.narl.org.tw/husoc/husokm" },
    { id: 44, category: "電子資料庫", title: "科技部-科技大觀園", desc: "累積了大量的科普影音、科技新知、科普文章、科普演講及各類科普活動訊息。", link: "https://scitechvista.nat.gov.tw/" },
    { id: 45, category: "電子資料庫", title: "動腦知識庫", desc: "<span class='text-danger fw-bold'>【臺灣學術電子資源永續發展計畫購置】</span>「動腦雜誌」1977年創刊，扮演著華文地區，廣告行銷媒體圈瞭望者的角色；讀者涵蓋台、中、港、新、馬、美國等地華文廣告界。每月定期提供最熱門的全球產業趨勢、專題報導、全球設計、行銷風向球、流行快報、網路公關案例、業界動態、及創意藍海專欄，是行銷傳播人不可或缺的產業交流資訊平台。「動腦知識庫」完整收錄「動腦雜誌」自1977年出刊至今的數位 ，化圖文資料精華，是培養成為未來行銷創意人才的專業雜誌。", link: "https://hsc.idm.oclc.org/login?url=https://brian93.lib.ntnu.edu.tw/brain93cgi/ttsweb?@brainkm" },
    { id: 46, category: "電子資料庫", title: "國家圖書館期刊文獻資訊網", desc: "包含「中華民國出版期刊指南系統」與「臺灣期刊論文索引系統」。", link: "https://tpl.ncl.edu.tw/" },
    { id: 47, category: "電子資料庫", title: "國家圖書館臺灣記憶系統", desc: "典藏豐富臺灣歷史資源，包括校園記憶、社會風貌、經濟發展等主題。", link: "https://tm.ncl.edu.tw/" },
    { id: 48, category: "電子資料庫", title: "貿協全球資訊網", desc: "由中華民國對外貿易發展協會（TAITRA，簡稱外貿協會）所維運的官方總入口網站。外貿協會本身是經濟部結合民間工商團體成立的公益財團法人，而該網站即為其開拓數位經貿的旗艦級門戶，旨在擔任「國際鏈結智慧整合中心（smart integrator）」，協助台灣中小企業迅速對接全球市場，推動數位轉型與跨境貿易。", link: "https://www.taitra.org.tw/" },
    { id: 49, category: "電子資料庫", title: "經濟統計資訊網路查詢系統", desc: "由中華民國經濟部統計處所建置的官方資料庫平台。其核心宗旨是整合經濟部管轄之各項重要經濟指標與工業、商業統計數據，提供產官學研及社會大眾一個具備時效性、準確性且可自由檢索的數位統計服務平台。", link: "https://www.moea.gov.tw/MNS/populace/content/ContentMenu.aspx?menu_id=6027" },
    { id: 50, category: "電子資料庫", title: "臺灣生命大百科", desc: "由林務局與中央研究院共同維運。將臺灣已知的生物以一物種一網頁的方式整合資訊。", link: "https://taieol.tw/" },
    { id: 51, category: "電子資料庫", title: "臺灣博碩士論文知識加值系統", desc: "由教育部委託國家圖書館建置的國家級學術資源平台，遵循「公開取閱(Open Access)」精神，免費提供全國各校博碩士論文查詢與電子全文下載（自88學年度起），收錄逾140萬筆書目，旨在推動學術研究共享、提升學術能見度。", link: "https://ndltd.ncl.edu.tw/" },
    { id: 52, category: "電子資料庫", title: "臺灣藝術教育網", desc: "建置全國藝術教育入口網站及藝術教學平台，並統整文學、音樂、視覺藝術等資源。", link: "https://ed.arte.gov.tw/" },
    { id: 53, category: "電子資料庫", title: "醫學百科", desc: "ADAM 醫學百科全書包括 4,000 多篇關於疾病、測試、症狀、損傷 and 手術的文章。", link: "https://www.nlm.nih.gov/medlineplus/encyclopedia.html" },

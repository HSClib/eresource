...
const allResources = [
    ...
    { id: 46, category: "電子資料庫", title: "貿協全球資訊網", desc: "由中華民國對外貿易發展協會（TAITRA，簡稱外貿協會）所維運的官方總入口網站。外貿協會本身是經濟部結合民間工商團體成立的公益財團法人，而該網站即為其開拓數位經貿的旗艦級門戶，旨在擔任「國際鏈結智慧整合中心（smart integrator）」，協助台灣中小企業迅速對接全球市場，推動數位轉型與跨境貿易。", link: "https://www.taitra.org.tw/" },
    { id: 47, category: "電子資料庫", title: "經濟統計資訊網路查詢系統", desc: "由中華民國經濟部統計處所建置的官方資料庫平台。其核心宗旨是整合經濟部管轄之各項重要經濟指標與工業、商業統計數據，提供產官學研及社會大眾一個具備時效性、準確性且可自由檢索的數位統計服務平台。", link: "https://www.moea.gov.tw/MNS/populace/content/ContentMenu.aspx?menu_id=6027" },
